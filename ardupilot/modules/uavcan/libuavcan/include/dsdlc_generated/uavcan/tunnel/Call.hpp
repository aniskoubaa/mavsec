 ...
 *
 * Source file: /home/azzathesis/ardupilot/modules/uavcan/dsdl/uavcan/tunnel/63.Call.uavcan
 */
...
struct UAVCAN_EXPORT Call_
{
    ...
    struct Request_
    {
        ...
        struct FieldTypes
        {
            ...
            typedef ::uavcan::Array< ::uavcan::IntegerSpec< 8, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate >, ::uavcan::ArrayModeDynamic, 1024 > buffer;
        };
            ...
            , buffer()
        {
             ...
             */
            ::uavcan::StaticAssert<8211 == MaxBitLen>::check();
    #endif
        }
    ...
    struct Response_
    {
            ...
            : buffer()
        {
             ...
             * actually depends on the nested types, thus it is not invariant.
             */
            ::uavcan::StaticAssert<8203 == MaxBitLen>::check();
    #endif
        }
...
{
    ::uavcan::DataTypeSignature signature(0x7EC6FACD89372D91ULL);
