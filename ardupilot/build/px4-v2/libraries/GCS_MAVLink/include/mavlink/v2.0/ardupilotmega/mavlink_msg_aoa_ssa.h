...
typedef struct __mavlink_aoa_ssa_t {
 ...
 float AOA; /*< [deg] Angle of Attack (degrees)*/
 float SSA; /*< [deg] Side Slip Angle (degrees)*/
}) mavlink_aoa_ssa_t;
 ...
 * @param AOA [deg] Angle of Attack (degrees)
 * @param SSA [deg] Side Slip Angle (degrees)
 ...
 *
 * @return [deg] Angle of Attack (degrees)
 */
 ...
 *
 * @return [deg] Side Slip Angle (degrees)
 */
