...
typedef struct __mavlink_wind_cov_t {
 ...
 float wind_x; /*< [m/s] Wind in X (NED) direction in m/s*/
 float wind_y; /*< [m/s] Wind in Y (NED) direction in m/s*/
 float wind_z; /*< [m/s] Wind in Z (NED) direction in m/s*/
 ...
 float wind_alt; /*< [m] AMSL altitude (m) this measurement was taken at*/
 ...
 * @param wind_x [m/s] Wind in X (NED) direction in m/s
 * @param wind_y [m/s] Wind in Y (NED) direction in m/s
 * @param wind_z [m/s] Wind in Z (NED) direction in m/s
 ...
 * @param wind_alt [m] AMSL altitude (m) this measurement was taken at
 ...
 *
 * @return [m/s] Wind in X (NED) direction in m/s
 */
 ...
 *
 * @return [m/s] Wind in Y (NED) direction in m/s
 */
 ...
 *
 * @return [m/s] Wind in Z (NED) direction in m/s
 */
 ...
 *
 * @return [m] AMSL altitude (m) this measurement was taken at
 */
