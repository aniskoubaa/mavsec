...
typedef struct __mavlink_optical_flow_t {
 uint64_t time_usec; /*< [us] Timestamp (UNIX)*/
 float flow_comp_m_x; /*< [m] Flow in meters in x-sensor direction, angular-speed compensated*/
 float flow_comp_m_y; /*< [m] Flow in meters in y-sensor direction, angular-speed compensated*/
 float ground_distance; /*< [m] Ground distance in meters. Positive value: distance known. Negative value: Unknown distance*/
 int16_t flow_x; /*< [dpixels] Flow in pixels * 10 in x-sensor direction (dezi-pixels)*/
 int16_t flow_y; /*< [dpixels] Flow in pixels * 10 in y-sensor direction (dezi-pixels)*/
 uint8_t sensor_id; /*<  Sensor ID*/
 uint8_t quality; /*<  Optical flow quality / confidence. 0: bad, 255: maximum quality*/
 float flow_rate_x; /*< [rad/s] Flow rate in radians/second about X axis*/
 float flow_rate_y; /*< [rad/s] Flow rate in radians/second about Y axis*/
 ...
 *
 * @param time_usec [us] Timestamp (UNIX)
 * @param sensor_id  Sensor ID
 * @param flow_x [dpixels] Flow in pixels * 10 in x-sensor direction (dezi-pixels)
 * @param flow_y [dpixels] Flow in pixels * 10 in y-sensor direction (dezi-pixels)
 * @param flow_comp_m_x [m] Flow in meters in x-sensor direction, angular-speed compensated
 * @param flow_comp_m_y [m] Flow in meters in y-sensor direction, angular-speed compensated
 * @param quality  Optical flow quality / confidence. 0: bad, 255: maximum quality
 * @param ground_distance [m] Ground distance in meters. Positive value: distance known. Negative value: Unknown distance
 * @param flow_rate_x [rad/s] Flow rate in radians/second about X axis
 * @param flow_rate_y [rad/s] Flow rate in radians/second about Y axis
 ...
 *
 * @return [dpixels] Flow in pixels * 10 in x-sensor direction (dezi-pixels)
 */
 ...
 *
 * @return [dpixels] Flow in pixels * 10 in y-sensor direction (dezi-pixels)
 */
 ...
 *
 * @return [m] Flow in meters in x-sensor direction, angular-speed compensated
 */
 ...
 *
 * @return [m] Flow in meters in y-sensor direction, angular-speed compensated
 */
 ...
 *
 * @return [m] Ground distance in meters. Positive value: distance known. Negative value: Unknown distance
 */
 ...
 *
 * @return [rad/s] Flow rate in radians/second about X axis
 */
 ...
 *
 * @return [rad/s] Flow rate in radians/second about Y axis
 */
