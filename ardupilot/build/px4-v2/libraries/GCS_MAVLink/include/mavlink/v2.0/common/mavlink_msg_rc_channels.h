...
typedef struct __mavlink_rc_channels_t {
 ...
 uint16_t chan1_raw; /*< [us] RC channel 1 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan2_raw; /*< [us] RC channel 2 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan3_raw; /*< [us] RC channel 3 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan4_raw; /*< [us] RC channel 4 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan5_raw; /*< [us] RC channel 5 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan6_raw; /*< [us] RC channel 6 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan7_raw; /*< [us] RC channel 7 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan8_raw; /*< [us] RC channel 8 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan9_raw; /*< [us] RC channel 9 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan10_raw; /*< [us] RC channel 10 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan11_raw; /*< [us] RC channel 11 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan12_raw; /*< [us] RC channel 12 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan13_raw; /*< [us] RC channel 13 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan14_raw; /*< [us] RC channel 14 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan15_raw; /*< [us] RC channel 15 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan16_raw; /*< [us] RC channel 16 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan17_raw; /*< [us] RC channel 17 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 uint16_t chan18_raw; /*< [us] RC channel 18 value, in microseconds. A value of UINT16_MAX implies the channel is unused.*/
 ...
 * @param chan1_raw [us] RC channel 1 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan2_raw [us] RC channel 2 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan3_raw [us] RC channel 3 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan4_raw [us] RC channel 4 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan5_raw [us] RC channel 5 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan6_raw [us] RC channel 6 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan7_raw [us] RC channel 7 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan8_raw [us] RC channel 8 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan9_raw [us] RC channel 9 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan10_raw [us] RC channel 10 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan11_raw [us] RC channel 11 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan12_raw [us] RC channel 12 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan13_raw [us] RC channel 13 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan14_raw [us] RC channel 14 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan15_raw [us] RC channel 15 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan16_raw [us] RC channel 16 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan17_raw [us] RC channel 17 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 * @param chan18_raw [us] RC channel 18 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 ...
 *
 * @return [us] RC channel 1 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 2 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 3 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 4 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 5 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 6 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 7 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 8 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 9 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 10 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 11 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 12 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 13 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 14 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 15 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 16 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 17 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
 ...
 *
 * @return [us] RC channel 18 value, in microseconds. A value of UINT16_MAX implies the channel is unused.
 */
