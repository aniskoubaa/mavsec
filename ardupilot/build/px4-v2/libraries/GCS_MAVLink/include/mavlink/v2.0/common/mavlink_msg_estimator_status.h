...
typedef struct __mavlink_estimator_status_t {
 ...
 float pos_horiz_accuracy; /*< [m] Horizontal position 1-STD accuracy relative to the EKF local origin (m)*/
 float pos_vert_accuracy; /*< [m] Vertical position 1-STD accuracy relative to the EKF local origin (m)*/
 ...
 * @param pos_horiz_accuracy [m] Horizontal position 1-STD accuracy relative to the EKF local origin (m)
 * @param pos_vert_accuracy [m] Vertical position 1-STD accuracy relative to the EKF local origin (m)
 ...
 *
 * @return [m] Horizontal position 1-STD accuracy relative to the EKF local origin (m)
 */
 ...
 *
 * @return [m] Vertical position 1-STD accuracy relative to the EKF local origin (m)
 */
