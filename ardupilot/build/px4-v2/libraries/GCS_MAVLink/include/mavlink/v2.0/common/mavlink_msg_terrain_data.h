...
typedef struct __mavlink_terrain_data_t {
 int32_t lat; /*< [degE7] Latitude of SW corner of first grid (degrees *10^7)*/
 int32_t lon; /*< [degE7] Longitude of SW corner of first grid (in degrees *10^7)*/
 uint16_t grid_spacing; /*< [m] Grid spacing in meters*/
 int16_t data[16]; /*< [m] Terrain data in meters AMSL*/
 ...
 *
 * @param lat [degE7] Latitude of SW corner of first grid (degrees *10^7)
 * @param lon [degE7] Longitude of SW corner of first grid (in degrees *10^7)
 * @param grid_spacing [m] Grid spacing in meters
 * @param gridbit  bit within the terrain request mask
 * @param data [m] Terrain data in meters AMSL
 ...
 *
 * @return [degE7] Latitude of SW corner of first grid (degrees *10^7)
 */
 ...
 *
 * @return [degE7] Longitude of SW corner of first grid (in degrees *10^7)
 */
 ...
 *
 * @return [m] Grid spacing in meters
 */
 ...
 *
 * @return [m] Terrain data in meters AMSL
 */
