...
typedef struct __mavlink_battery2_t {
 ...
 int16_t current_battery; /*< [cA] Battery current, in centiamperes (1 = 10 milliampere), -1: autopilot does not measure the current*/
}) mavlink_battery2_t;
 ...
 * @param current_battery [cA] Battery current, in centiamperes (1 = 10 milliampere), -1: autopilot does not measure the current
 ...
 *
 * @return [cA] Battery current, in centiamperes (1 = 10 milliampere), -1: autopilot does not measure the current
 */
