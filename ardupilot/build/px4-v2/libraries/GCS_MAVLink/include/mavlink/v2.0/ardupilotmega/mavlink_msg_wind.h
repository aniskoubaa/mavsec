...
typedef struct __mavlink_wind_t {
 float direction; /*< [deg] wind direction that wind is coming from (degrees)*/
 float speed; /*< [m/s] wind speed in ground plane (m/s)*/
 float speed_z; /*< [m/s] vertical wind speed (m/s)*/
}) mavlink_wind_t;
 ...
 *
 * @param direction [deg] wind direction that wind is coming from (degrees)
 * @param speed [m/s] wind speed in ground plane (m/s)
 * @param speed_z [m/s] vertical wind speed (m/s)
 ...
 *
 * @return [deg] wind direction that wind is coming from (degrees)
 */
 ...
 *
 * @return [m/s] wind speed in ground plane (m/s)
 */
 ...
 *
 * @return [m/s] vertical wind speed (m/s)
 */
