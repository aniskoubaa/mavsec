...
typedef struct __mavlink_mount_orientation_t {
 ...
 float roll; /*< [deg] Roll in global frame in degrees (set to NaN for invalid).*/
 float pitch; /*< [deg] Pitch in global frame in degrees (set to NaN for invalid).*/
 float yaw; /*< [deg] Yaw relative to vehicle in degrees (set to NaN for invalid).*/
 float yaw_absolute; /*< [deg] Yaw in absolute frame in degrees, North is 0 (set to NaN for invalid).*/
 ...
 * @param roll [deg] Roll in global frame in degrees (set to NaN for invalid).
 * @param pitch [deg] Pitch in global frame in degrees (set to NaN for invalid).
 * @param yaw [deg] Yaw relative to vehicle in degrees (set to NaN for invalid).
 * @param yaw_absolute [deg] Yaw in absolute frame in degrees, North is 0 (set to NaN for invalid).
 ...
 *
 * @return [deg] Roll in global frame in degrees (set to NaN for invalid).
 */
 ...
 *
 * @return [deg] Pitch in global frame in degrees (set to NaN for invalid).
 */
 ...
 *
 * @return [deg] Yaw relative to vehicle in degrees (set to NaN for invalid).
 */
 ...
 *
 * @return [deg] Yaw in absolute frame in degrees, North is 0 (set to NaN for invalid).
 */
