...
typedef struct __mavlink_pid_tuning_t {
 float desired; /*< [deg/s] desired rate (degrees/s)*/
 float achieved; /*< [deg/s] achieved rate (degrees/s)*/
 ...
 *
 * @param axis  axis
 * @param desired [deg/s] desired rate (degrees/s)
 * @param achieved [deg/s] achieved rate (degrees/s)
 ...
 *
 * @return [deg/s] desired rate (degrees/s)
 */
 ...
 *
 * @return [deg/s] achieved rate (degrees/s)
 */
