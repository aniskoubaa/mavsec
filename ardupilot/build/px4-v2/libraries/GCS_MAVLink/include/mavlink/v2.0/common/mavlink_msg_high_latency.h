...
typedef struct __mavlink_high_latency_t {
 ...
 int32_t latitude; /*< [degE7] Latitude, expressed as degrees * 1E7*/
 int32_t longitude; /*< [degE7] Longitude, expressed as degrees * 1E7*/
 int16_t roll; /*< [cdeg] roll (centidegrees)*/
 int16_t pitch; /*< [cdeg] pitch (centidegrees)*/
 uint16_t heading; /*< [cdeg] heading (centidegrees)*/
 int16_t heading_sp; /*< [cdeg] heading setpoint (centidegrees)*/
 int16_t altitude_amsl; /*< [m] Altitude above mean sea level (meters)*/
 int16_t altitude_sp; /*< [m] Altitude setpoint relative to the home position (meters)*/
 uint16_t wp_distance; /*< [m] distance to target (meters)*/
 ...
 uint8_t airspeed; /*< [m/s] airspeed (m/s)*/
 uint8_t airspeed_sp; /*< [m/s] airspeed setpoint (m/s)*/
 uint8_t groundspeed; /*< [m/s] groundspeed (m/s)*/
 int8_t climb_rate; /*< [m/s] climb rate (m/s)*/
 ...
 * @param roll [cdeg] roll (centidegrees)
 * @param pitch [cdeg] pitch (centidegrees)
 * @param heading [cdeg] heading (centidegrees)
 * @param throttle [%] throttle (percentage)
 * @param heading_sp [cdeg] heading setpoint (centidegrees)
 * @param latitude [degE7] Latitude, expressed as degrees * 1E7
 * @param longitude [degE7] Longitude, expressed as degrees * 1E7
 * @param altitude_amsl [m] Altitude above mean sea level (meters)
 * @param altitude_sp [m] Altitude setpoint relative to the home position (meters)
 * @param airspeed [m/s] airspeed (m/s)
 * @param airspeed_sp [m/s] airspeed setpoint (m/s)
 * @param groundspeed [m/s] groundspeed (m/s)
 * @param climb_rate [m/s] climb rate (m/s)
 ...
 * @param wp_distance [m] distance to target (meters)
 ...
 *
 * @return [cdeg] pitch (centidegrees)
 */
 ...
 *
 * @return [cdeg] heading (centidegrees)
 */
 ...
 *
 * @return [cdeg] heading setpoint (centidegrees)
 */
 ...
 *
 * @return [m] Altitude above mean sea level (meters)
 */
 ...
 *
 * @return [m] Altitude setpoint relative to the home position (meters)
 */
 ...
 *
 * @return [m/s] airspeed setpoint (m/s)
 */
 ...
 *
 * @return [m] distance to target (meters)
 */
