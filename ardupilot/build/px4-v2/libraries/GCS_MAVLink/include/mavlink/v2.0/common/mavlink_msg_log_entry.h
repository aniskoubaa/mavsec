...
typedef struct __mavlink_log_entry_t {
 uint32_t time_utc; /*< [s] UTC timestamp of log in seconds since 1970, or 0 if not available*/
 uint32_t size; /*< [bytes] Size of the log (may be approximate) in bytes*/
 uint16_t id; /*<  Log id*/
 ...
 * @param time_utc [s] UTC timestamp of log in seconds since 1970, or 0 if not available
 * @param size [bytes] Size of the log (may be approximate) in bytes
 ...
 *
 * @return [s] UTC timestamp of log in seconds since 1970, or 0 if not available
 */
 ...
 *
 * @return [bytes] Size of the log (may be approximate) in bytes
 */
