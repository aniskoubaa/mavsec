...
typedef struct __mavlink_camera_capture_status_t {
 ...
 float image_interval; /*< [s] Image capture interval in seconds*/
 float video_framerate; /*< [Hz] Video frame rate in Hz*/
 uint32_t recording_time_ms; /*< [ms] Time in milliseconds since recording started*/
 float available_capacity; /*< [Mibytes] Available storage capacity in MiB*/
 uint16_t image_resolution_h; /*< [pix] Image resolution in pixels horizontal*/
 uint16_t image_resolution_v; /*< [pix] Image resolution in pixels vertical*/
 uint16_t video_resolution_h; /*< [pix] Video resolution in pixels horizontal*/
 uint16_t video_resolution_v; /*< [pix] Video resolution in pixels vertical*/
 ...
 * @param image_interval [s] Image capture interval in seconds
 * @param video_framerate [Hz] Video frame rate in Hz
 * @param image_resolution_h [pix] Image resolution in pixels horizontal
 * @param image_resolution_v [pix] Image resolution in pixels vertical
 * @param video_resolution_h [pix] Video resolution in pixels horizontal
 * @param video_resolution_v [pix] Video resolution in pixels vertical
 * @param recording_time_ms [ms] Time in milliseconds since recording started
 * @param available_capacity [Mibytes] Available storage capacity in MiB
 ...
 *
 * @return [s] Image capture interval in seconds
 */
 ...
 *
 * @return [Hz] Video frame rate in Hz
 */
 ...
 *
 * @return [pix] Image resolution in pixels horizontal
 */
 ...
 *
 * @return [pix] Image resolution in pixels vertical
 */
 ...
 *
 * @return [pix] Video resolution in pixels horizontal
 */
 ...
 *
 * @return [pix] Video resolution in pixels vertical
 */
 ...
 *
 * @return [ms] Time in milliseconds since recording started
 */
 ...
 *
 * @return [Mibytes] Available storage capacity in MiB
 */
