...
typedef struct __mavlink_deepstall_t {
 int32_t landing_lat; /*< [degE7] Landing latitude (deg * 1E7)*/
 int32_t landing_lon; /*< [degE7] Landing longitude (deg * 1E7)*/
 int32_t path_lat; /*< [degE7] Final heading start point, latitude (deg * 1E7)*/
 int32_t path_lon; /*< [degE7] Final heading start point, longitude (deg * 1E7)*/
 int32_t arc_entry_lat; /*< [degE7] Arc entry point, latitude (deg * 1E7)*/
 int32_t arc_entry_lon; /*< [degE7] Arc entry point, longitude (deg * 1E7)*/
 float altitude; /*< [m] Altitude (meters)*/
 float expected_travel_distance; /*< [m] Distance the aircraft expects to travel during the deepstall*/
 float cross_track_error; /*< [m] Deepstall cross track error in meters (only valid when in DEEPSTALL_STAGE_LAND)*/
 ...
 *
 * @param landing_lat [degE7] Landing latitude (deg * 1E7)
 * @param landing_lon [degE7] Landing longitude (deg * 1E7)
 * @param path_lat [degE7] Final heading start point, latitude (deg * 1E7)
 * @param path_lon [degE7] Final heading start point, longitude (deg * 1E7)
 * @param arc_entry_lat [degE7] Arc entry point, latitude (deg * 1E7)
 * @param arc_entry_lon [degE7] Arc entry point, longitude (deg * 1E7)
 * @param altitude [m] Altitude (meters)
 * @param expected_travel_distance [m] Distance the aircraft expects to travel during the deepstall
 * @param cross_track_error [m] Deepstall cross track error in meters (only valid when in DEEPSTALL_STAGE_LAND)
 ...
 *
 * @return [degE7] Landing latitude (deg * 1E7)
 */
 ...
 *
 * @return [degE7] Landing longitude (deg * 1E7)
 */
 ...
 *
 * @return [degE7] Final heading start point, latitude (deg * 1E7)
 */
 ...
 *
 * @return [degE7] Final heading start point, longitude (deg * 1E7)
 */
 ...
 *
 * @return [degE7] Arc entry point, latitude (deg * 1E7)
 */
 ...
 *
 * @return [degE7] Arc entry point, longitude (deg * 1E7)
 */
 ...
 *
 * @return [m] Deepstall cross track error in meters (only valid when in DEEPSTALL_STAGE_LAND)
 */
