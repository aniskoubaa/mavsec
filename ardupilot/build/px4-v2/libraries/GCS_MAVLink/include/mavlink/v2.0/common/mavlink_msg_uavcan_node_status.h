...
typedef struct __mavlink_uavcan_node_status_t {
 ...
 uint32_t uptime_sec; /*< [s] The number of seconds since the start-up of the node.*/
 ...
 * @param uptime_sec [s] The number of seconds since the start-up of the node.
 ...
 *
 * @return [s] The number of seconds since the start-up of the node.
 */
