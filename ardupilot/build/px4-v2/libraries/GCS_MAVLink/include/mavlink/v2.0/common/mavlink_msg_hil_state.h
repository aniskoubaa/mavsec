...
typedef struct __mavlink_hil_state_t {
 ...
 int16_t vx; /*< [cm/s] Ground X Speed (Latitude), expressed as m/s * 100*/
 int16_t vy; /*< [cm/s] Ground Y Speed (Longitude), expressed as m/s * 100*/
 int16_t vz; /*< [cm/s] Ground Z Speed (Altitude), expressed as m/s * 100*/
 ...
 * @param vx [cm/s] Ground X Speed (Latitude), expressed as m/s * 100
 * @param vy [cm/s] Ground Y Speed (Longitude), expressed as m/s * 100
 * @param vz [cm/s] Ground Z Speed (Altitude), expressed as m/s * 100
 ...
 *
 * @return [cm/s] Ground X Speed (Latitude), expressed as m/s * 100
 */
 ...
 *
 * @return [cm/s] Ground Y Speed (Longitude), expressed as m/s * 100
 */
 ...
 *
 * @return [cm/s] Ground Z Speed (Altitude), expressed as m/s * 100
 */
