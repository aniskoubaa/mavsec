...
typedef struct __mavlink_collision_t {
 ...
 float time_to_minimum_delta; /*< [s] Estimated time until collision occurs (seconds)*/
 float altitude_minimum_delta; /*< [m] Closest vertical distance in meters between vehicle and object*/
 float horizontal_minimum_delta; /*< [m] Closest horizontal distance in meteres between vehicle and object*/
 ...
 * @param time_to_minimum_delta [s] Estimated time until collision occurs (seconds)
 * @param altitude_minimum_delta [m] Closest vertical distance in meters between vehicle and object
 * @param horizontal_minimum_delta [m] Closest horizontal distance in meteres between vehicle and object
 ...
 *
 * @return [s] Estimated time until collision occurs (seconds)
 */
 ...
 *
 * @return [m] Closest vertical distance in meters between vehicle and object
 */
 ...
 *
 * @return [m] Closest horizontal distance in meteres between vehicle and object
 */
