...
typedef struct __mavlink_gps2_raw_t {
 ...
 uint16_t eph; /*< [cm] GPS HDOP horizontal dilution of position in cm (m*100). If unknown, set to: UINT16_MAX*/
 uint16_t epv; /*< [cm] GPS VDOP vertical dilution of position in cm (m*100). If unknown, set to: UINT16_MAX*/
 ...
 * @param eph [cm] GPS HDOP horizontal dilution of position in cm (m*100). If unknown, set to: UINT16_MAX
 * @param epv [cm] GPS VDOP vertical dilution of position in cm (m*100). If unknown, set to: UINT16_MAX
 ...
 *
 * @return [cm] GPS HDOP horizontal dilution of position in cm (m*100). If unknown, set to: UINT16_MAX
 */
 ...
 *
 * @return [cm] GPS VDOP vertical dilution of position in cm (m*100). If unknown, set to: UINT16_MAX
 */
 ...
 *
 * @return [cm/s] GPS ground speed (m/s * 100). If unknown, set to: UINT16_MAX
 */
