...
typedef struct __mavlink_system_time_t {
 ...
 uint32_t time_boot_ms; /*< [ms] Timestamp of the component clock since boot time in milliseconds.*/
 ...
 * @param time_boot_ms [ms] Timestamp of the component clock since boot time in milliseconds.
 ...
 *
 * @return [ms] Timestamp of the component clock since boot time in milliseconds.
 */
