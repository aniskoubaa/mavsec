 ...
 * @param focal_length [mm] Focal length in mm
 * @param sensor_size_h [mm] Image sensor size horizontal in mm
 * @param sensor_size_v [mm] Image sensor size vertical in mm
 * @param resolution_h [pix] Image resolution in pixels horizontal
 * @param resolution_v [pix] Image resolution in pixels vertical
 ...
 *
 * @return [mm] Image sensor size horizontal in mm
 */
 ...
 *
 * @return [mm] Image sensor size vertical in mm
 */
