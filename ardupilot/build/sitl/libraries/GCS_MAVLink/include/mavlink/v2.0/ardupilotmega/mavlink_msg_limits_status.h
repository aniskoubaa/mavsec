...
typedef struct __mavlink_limits_status_t {
 uint32_t last_trigger; /*< [ms] time of last breach in milliseconds since boot*/
 uint32_t last_action; /*< [ms] time of last recovery action in milliseconds since boot*/
 uint32_t last_recovery; /*< [ms] time of last successful recovery in milliseconds since boot*/
 uint32_t last_clear; /*< [ms] time of last all-clear in milliseconds since boot*/
 ...
 * @param last_trigger [ms] time of last breach in milliseconds since boot
 * @param last_action [ms] time of last recovery action in milliseconds since boot
 * @param last_recovery [ms] time of last successful recovery in milliseconds since boot
 * @param last_clear [ms] time of last all-clear in milliseconds since boot
 ...
 *
 * @return [ms] time of last recovery action in milliseconds since boot
 */
 ...
 *
 * @return [ms] time of last successful recovery in milliseconds since boot
 */
 ...
 *
 * @return [ms] time of last all-clear in milliseconds since boot
 */
