...
typedef struct __mavlink_scaled_pressure_t {
 ...
 float press_abs; /*< [hPa] Absolute pressure (hectopascal)*/
 float press_diff; /*< [hPa] Differential pressure 1 (hectopascal)*/
 int16_t temperature; /*< [cdegC] Temperature measurement (0.01 degrees celsius)*/
 ...
 * @param press_abs [hPa] Absolute pressure (hectopascal)
 * @param press_diff [hPa] Differential pressure 1 (hectopascal)
 * @param temperature [cdegC] Temperature measurement (0.01 degrees celsius)
 ...
 *
 * @return [hPa] Absolute pressure (hectopascal)
 */
 ...
 *
 * @return [hPa] Differential pressure 1 (hectopascal)
 */
 ...
 *
 * @return [cdegC] Temperature measurement (0.01 degrees celsius)
 */
