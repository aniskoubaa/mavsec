...
typedef struct __mavlink_camera_feedback_t {
 uint64_t time_usec; /*< [us] Image timestamp (microseconds since UNIX epoch), as passed in by CAMERA_STATUS message (or autopilot if no CCB)*/
 int32_t lat; /*< [degE7] Latitude in (deg * 1E7)*/
 int32_t lng; /*< [degE7] Longitude in (deg * 1E7)*/
 float alt_msl; /*< [m] Altitude Absolute (meters AMSL)*/
 float alt_rel; /*< [m] Altitude Relative (meters above HOME location)*/
 float roll; /*< [deg] Camera Roll angle (earth frame, degrees, +-180)*/
 float pitch; /*< [deg] Camera Pitch angle (earth frame, degrees, +-180)*/
 float yaw; /*< [deg] Camera Yaw (earth frame, degrees, 0-360, true)*/
 float foc_len; /*< [mm] Focal Length (mm)*/
 ...
 *
 * @param time_usec [us] Image timestamp (microseconds since UNIX epoch), as passed in by CAMERA_STATUS message (or autopilot if no CCB)
 * @param target_system  System ID
 * @param cam_idx  Camera ID
 * @param img_idx  Image index
 * @param lat [degE7] Latitude in (deg * 1E7)
 * @param lng [degE7] Longitude in (deg * 1E7)
 * @param alt_msl [m] Altitude Absolute (meters AMSL)
 * @param alt_rel [m] Altitude Relative (meters above HOME location)
 * @param roll [deg] Camera Roll angle (earth frame, degrees, +-180)
 * @param pitch [deg] Camera Pitch angle (earth frame, degrees, +-180)
 * @param yaw [deg] Camera Yaw (earth frame, degrees, 0-360, true)
 * @param foc_len [mm] Focal Length (mm)
 ...
 *
 * @return [us] Image timestamp (microseconds since UNIX epoch), as passed in by CAMERA_STATUS message (or autopilot if no CCB)
 */
 ...
 *
 * @return [degE7] Latitude in (deg * 1E7)
 */
 ...
 *
 * @return [degE7] Longitude in (deg * 1E7)
 */
 ...
 *
 * @return [m] Altitude Absolute (meters AMSL)
 */
 ...
 *
 * @return [m] Altitude Relative (meters above HOME location)
 */
 ...
 *
 * @return [deg] Camera Roll angle (earth frame, degrees, +-180)
 */
 ...
 *
 * @return [deg] Camera Pitch angle (earth frame, degrees, +-180)
 */
 ...
 *
 * @return [deg] Camera Yaw (earth frame, degrees, 0-360, true)
 */
