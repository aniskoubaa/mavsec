...
typedef struct __mavlink_nav_controller_output_t {
 float nav_roll; /*< [deg] Current desired roll in degrees*/
 float nav_pitch; /*< [deg] Current desired pitch in degrees*/
 float alt_error; /*< [m] Current altitude error in meters*/
 float aspd_error; /*< [m/s] Current airspeed error in meters/second*/
 float xtrack_error; /*< [m] Current crosstrack error on x-y plane in meters*/
 int16_t nav_bearing; /*< [deg] Current desired heading in degrees*/
 int16_t target_bearing; /*< [deg] Bearing to current waypoint/target in degrees*/
 uint16_t wp_dist; /*< [m] Distance to active waypoint in meters*/
 ...
 *
 * @param nav_roll [deg] Current desired roll in degrees
 * @param nav_pitch [deg] Current desired pitch in degrees
 * @param nav_bearing [deg] Current desired heading in degrees
 * @param target_bearing [deg] Bearing to current waypoint/target in degrees
 * @param wp_dist [m] Distance to active waypoint in meters
 * @param alt_error [m] Current altitude error in meters
 * @param aspd_error [m/s] Current airspeed error in meters/second
 * @param xtrack_error [m] Current crosstrack error on x-y plane in meters
 ...
 *
 * @return [deg] Current desired roll in degrees
 */
 ...
 *
 * @return [deg] Current desired pitch in degrees
 */
 ...
 *
 * @return [deg] Current desired heading in degrees
 */
 ...
 *
 * @return [deg] Bearing to current waypoint/target in degrees
 */
 ...
 *
 * @return [m] Distance to active waypoint in meters
 */
 ...
 *
 * @return [m] Current altitude error in meters
 */
 ...
 *
 * @return [m/s] Current airspeed error in meters/second
 */
 ...
 *
 * @return [m] Current crosstrack error on x-y plane in meters
 */
