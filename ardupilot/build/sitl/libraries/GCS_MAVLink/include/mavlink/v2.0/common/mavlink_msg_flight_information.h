...
typedef struct __mavlink_flight_information_t {
 uint64_t arming_time_utc; /*< [us] Timestamp at arming (microseconds since UNIX epoch) in UTC, 0 for unknown*/
 uint64_t takeoff_time_utc; /*< [us] Timestamp at takeoff (microseconds since UNIX epoch) in UTC, 0 for unknown*/
 ...
 * @param arming_time_utc [us] Timestamp at arming (microseconds since UNIX epoch) in UTC, 0 for unknown
 * @param takeoff_time_utc [us] Timestamp at takeoff (microseconds since UNIX epoch) in UTC, 0 for unknown
 ...
 *
 * @return [us] Timestamp at arming (microseconds since UNIX epoch) in UTC, 0 for unknown
 */
 ...
 *
 * @return [us] Timestamp at takeoff (microseconds since UNIX epoch) in UTC, 0 for unknown
 */
