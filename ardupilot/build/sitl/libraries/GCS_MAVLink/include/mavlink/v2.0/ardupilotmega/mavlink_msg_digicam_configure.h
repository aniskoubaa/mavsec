...
typedef struct __mavlink_digicam_configure_t {
 ...
 uint8_t engine_cut_off; /*< [ds] Main engine cut-off time before camera trigger in seconds/10 (0 means no cut-off)*/
 ...
 * @param engine_cut_off [ds] Main engine cut-off time before camera trigger in seconds/10 (0 means no cut-off)
 ...
 *
 * @return [ds] Main engine cut-off time before camera trigger in seconds/10 (0 means no cut-off)
 */
