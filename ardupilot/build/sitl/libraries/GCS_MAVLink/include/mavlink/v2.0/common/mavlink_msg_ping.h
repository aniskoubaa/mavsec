...
typedef struct __mavlink_ping_t {
 uint64_t time_usec; /*< [us] Unix timestamp in microseconds or since system boot if smaller than MAVLink epoch (1.1.2009)*/
 ...
 *
 * @param time_usec [us] Unix timestamp in microseconds or since system boot if smaller than MAVLink epoch (1.1.2009)
 ...
 *
 * @return [us] Unix timestamp in microseconds or since system boot if smaller than MAVLink epoch (1.1.2009)
 */
