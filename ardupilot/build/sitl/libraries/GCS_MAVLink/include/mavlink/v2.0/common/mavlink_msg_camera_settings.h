...
typedef struct __mavlink_camera_settings_t {
 ...
 float shutter_speed; /*< [s] Shutter speed in s*/
 float iso_sensitivity; /*<  ISO sensitivity*/
 float white_balance; /*< [K] Color temperature in degrees Kelvin*/
 ...
 * @param shutter_speed [s] Shutter speed in s
 ...
 * @param white_balance [K] Color temperature in degrees Kelvin
 ...
 *
 * @return [K] Color temperature in degrees Kelvin
 */
