...
typedef struct __mavlink_gps_rtk_t {
 uint32_t time_last_baseline_ms; /*< [ms] Time since boot of last baseline message received in ms.*/
 uint32_t tow; /*< [ms] GPS Time of Week of last baseline*/
 int32_t baseline_a_mm; /*< [mm] Current baseline in ECEF x or NED north component in mm.*/
 int32_t baseline_b_mm; /*< [mm] Current baseline in ECEF y or NED east component in mm.*/
 int32_t baseline_c_mm; /*< [mm] Current baseline in ECEF z or NED down component in mm.*/
 ...
 uint8_t rtk_rate; /*< [Hz] Rate of baseline messages being received by GPS, in HZ*/
 ...
 *
 * @param time_last_baseline_ms [ms] Time since boot of last baseline message received in ms.
 ...
 * @param rtk_rate [Hz] Rate of baseline messages being received by GPS, in HZ
 * @param nsats  Current number of sats used for RTK calculation.
 * @param baseline_coords_type  Coordinate system of baseline
 * @param baseline_a_mm [mm] Current baseline in ECEF x or NED north component in mm.
 * @param baseline_b_mm [mm] Current baseline in ECEF y or NED east component in mm.
 * @param baseline_c_mm [mm] Current baseline in ECEF z or NED down component in mm.
 ...
 *
 * @return [ms] Time since boot of last baseline message received in ms.
 */
 ...
 *
 * @return [Hz] Rate of baseline messages being received by GPS, in HZ
 */
 ...
 *
 * @return [mm] Current baseline in ECEF x or NED north component in mm.
 */
 ...
 *
 * @return [mm] Current baseline in ECEF y or NED east component in mm.
 */
 ...
 *
 * @return [mm] Current baseline in ECEF z or NED down component in mm.
 */
