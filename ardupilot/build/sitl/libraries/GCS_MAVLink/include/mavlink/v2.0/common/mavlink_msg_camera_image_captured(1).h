...
typedef struct __mavlink_camera_image_captured_t {
 uint64_t time_utc; /*< [us] Timestamp (microseconds since UNIX epoch) in UTC. 0 for unknown.*/
 uint32_t time_boot_ms; /*< [ms] Timestamp (milliseconds since system boot)*/
 int32_t lat; /*< [degE7] Latitude, expressed as degrees * 1E7 where image was taken*/
 int32_t lon; /*< [degE7] Longitude, expressed as degrees * 1E7 where capture was taken*/
 int32_t alt; /*< [m] Altitude in meters, expressed as * 1E3 (AMSL, not WGS84) where image was taken*/
 int32_t relative_alt; /*< [m] Altitude above ground in meters, expressed as * 1E3 where image was taken*/
 ...
 * @param time_utc [us] Timestamp (microseconds since UNIX epoch) in UTC. 0 for unknown.
 * @param camera_id  Camera ID (1 for first, 2 for second, etc.)
 * @param lat [degE7] Latitude, expressed as degrees * 1E7 where image was taken
 * @param lon [degE7] Longitude, expressed as degrees * 1E7 where capture was taken
 * @param alt [m] Altitude in meters, expressed as * 1E3 (AMSL, not WGS84) where image was taken
 * @param relative_alt [m] Altitude above ground in meters, expressed as * 1E3 where image was taken
 ...
 *
 * @return [us] Timestamp (microseconds since UNIX epoch) in UTC. 0 for unknown.
 */
 ...
 *
 * @return [degE7] Latitude, expressed as degrees * 1E7 where image was taken
 */
 ...
 *
 * @return [degE7] Longitude, expressed as degrees * 1E7 where capture was taken
 */
 ...
 *
 * @return [m] Altitude in meters, expressed as * 1E3 (AMSL, not WGS84) where image was taken
 */
 ...
 *
 * @return [m] Altitude above ground in meters, expressed as * 1E3 where image was taken
 */
