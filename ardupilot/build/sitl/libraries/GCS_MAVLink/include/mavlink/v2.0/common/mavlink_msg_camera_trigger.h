...
typedef struct __mavlink_camera_trigger_t {
 uint64_t time_usec; /*< [us] Timestamp for the image frame in microseconds*/
 ...
 *
 * @param time_usec [us] Timestamp for the image frame in microseconds
 ...
 *
 * @return [us] Timestamp for the image frame in microseconds
 */
