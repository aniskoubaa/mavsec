...
typedef struct __mavlink_distance_sensor_t {
 uint32_t time_boot_ms; /*< [ms] Time since system boot*/
 ...
 uint8_t covariance; /*< [cm] Measurement covariance in centimeters, 0 for unknown / invalid readings*/
 ...
 *
 * @param time_boot_ms [ms] Time since system boot
 ...
 * @param covariance [cm] Measurement covariance in centimeters, 0 for unknown / invalid readings
 ...
 *
 * @return [cm] Measurement covariance in centimeters, 0 for unknown / invalid readings
 */
