...
typedef struct __mavlink_sys_status_t {
 ...
 uint16_t load; /*< [d%] Maximum usage in percent of the mainloop time, (0%: 0, 100%: 1000) should be always below 1000*/
 uint16_t voltage_battery; /*< [mV] Battery voltage, in millivolts (1 = 1 millivolt)*/
 int16_t current_battery; /*< [cA] Battery current, in 10*milliamperes (1 = 10 milliampere), -1: autopilot does not measure the current*/
 uint16_t drop_rate_comm; /*< [c%] Communication drops in percent, (0%: 0, 100%: 10'000), (UART, I2C, SPI, CAN), dropped packets on all links (packets that were corrupted on reception on the MAV)*/
 ...
 * @param load [d%] Maximum usage in percent of the mainloop time, (0%: 0, 100%: 1000) should be always below 1000
 * @param voltage_battery [mV] Battery voltage, in millivolts (1 = 1 millivolt)
 ...
 * @param drop_rate_comm [c%] Communication drops in percent, (0%: 0, 100%: 10'000), (UART, I2C, SPI, CAN), dropped packets on all links (packets that were corrupted on reception on the MAV)
 ...
 *
 * @return [d%] Maximum usage in percent of the mainloop time, (0%: 0, 100%: 1000) should be always below 1000
 */
 ...
 *
 * @return [mV] Battery voltage, in millivolts (1 = 1 millivolt)
 */
 ...
 *
 * @return [c%] Communication drops in percent, (0%: 0, 100%: 10'000), (UART, I2C, SPI, CAN), dropped packets on all links (packets that were corrupted on reception on the MAV)
 */
