...
typedef struct __mavlink_global_position_int_cov_t {
 ...
 int32_t alt; /*< [mm] Altitude in meters, expressed as * 1000 (millimeters), above MSL*/
 int32_t relative_alt; /*< [mm] Altitude above ground in meters, expressed as * 1000 (millimeters)*/
 float vx; /*< [m/s] Ground X Speed (Latitude), expressed as m/s*/
 float vy; /*< [m/s] Ground Y Speed (Longitude), expressed as m/s*/
 float vz; /*< [m/s] Ground Z Speed (Altitude), expressed as m/s*/
 ...
 * @param alt [mm] Altitude in meters, expressed as * 1000 (millimeters), above MSL
 * @param relative_alt [mm] Altitude above ground in meters, expressed as * 1000 (millimeters)
 * @param vx [m/s] Ground X Speed (Latitude), expressed as m/s
 * @param vy [m/s] Ground Y Speed (Longitude), expressed as m/s
 * @param vz [m/s] Ground Z Speed (Altitude), expressed as m/s
 ...
 *
 * @return [mm] Altitude in meters, expressed as * 1000 (millimeters), above MSL
 */
 ...
 *
 * @return [m/s] Ground X Speed (Latitude), expressed as m/s
 */
 ...
 *
 * @return [m/s] Ground Y Speed (Longitude), expressed as m/s
 */
 ...
 *
 * @return [m/s] Ground Z Speed (Altitude), expressed as m/s
 */
