...
typedef struct __mavlink_storage_information_t {
 ...
 float total_capacity; /*< [Mibytes] Total capacity in MiB*/
 float used_capacity; /*< [Mibytes] Used capacity in MiB*/
 float available_capacity; /*< [Mibytes] Available capacity in MiB*/
 float read_speed; /*< [Mibytes/s] Read speed in MiB/s*/
 float write_speed; /*< [Mibytes/s] Write speed in MiB/s*/
 ...
 * @param total_capacity [Mibytes] Total capacity in MiB
 * @param used_capacity [Mibytes] Used capacity in MiB
 * @param available_capacity [Mibytes] Available capacity in MiB
 * @param read_speed [Mibytes/s] Read speed in MiB/s
 * @param write_speed [Mibytes/s] Write speed in MiB/s
 ...
 *
 * @return [Mibytes] Total capacity in MiB
 */
 ...
 *
 * @return [Mibytes] Used capacity in MiB
 */
 ...
 *
 * @return [Mibytes] Available capacity in MiB
 */
 ...
 *
 * @return [Mibytes/s] Read speed in MiB/s
 */
 ...
 *
 * @return [Mibytes/s] Write speed in MiB/s
 */
