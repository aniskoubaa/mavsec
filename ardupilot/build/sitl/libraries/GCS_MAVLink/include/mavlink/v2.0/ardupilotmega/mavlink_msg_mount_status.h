...
typedef struct __mavlink_mount_status_t {
 int32_t pointing_a; /*< [cdeg] pitch(deg*100)*/
 int32_t pointing_b; /*< [cdeg] roll(deg*100)*/
 int32_t pointing_c; /*< [cdeg] yaw(deg*100)*/
 ...
 * @param pointing_a [cdeg] pitch(deg*100)
 * @param pointing_b [cdeg] roll(deg*100)
 * @param pointing_c [cdeg] yaw(deg*100)
