...
typedef struct __mavlink_manual_setpoint_t {
 ...
 float roll; /*< [rad/s] Desired roll rate in radians per second*/
 float pitch; /*< [rad/s] Desired pitch rate in radians per second*/
 float yaw; /*< [rad/s] Desired yaw rate in radians per second*/
 ...
 * @param roll [rad/s] Desired roll rate in radians per second
 * @param pitch [rad/s] Desired pitch rate in radians per second
 * @param yaw [rad/s] Desired yaw rate in radians per second
 ...
 *
 * @return [rad/s] Desired roll rate in radians per second
 */
 ...
 *
 * @return [rad/s] Desired pitch rate in radians per second
 */
 ...
 *
 * @return [rad/s] Desired yaw rate in radians per second
 */
